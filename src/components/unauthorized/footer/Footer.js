...
const infos = [
    {
        icon: <PhoneIcon/>,
        description: "+370 0000000 (Placeholder)"
    },
    {
        icon: <MailIcon/>,
        description: "paulius.mac92@gmail.com"
    }
];
...
const socialIcons = [
    ...
    },
    {
        ...
        label: "LinkedIn",
        href: "https://www.linkedin.com/in/paulius-maciukevi%C4%8Dius/"
                ...
                <Grid container spacing={isWidthUp("md", width) ? 10 : 5}>
                    ...
                    <Grid item xs={6} md={6} lg={6}>
                        ...
                        <Typography style={{color: "#8f9296"}} paragraph>
                            Starting fullstack SPA styled with material UI, java/spring boot as
                            back end and react 16+ as front end.
                        </Typography>
                        <Box display="flex">
